...
class PostItemRepository  @Inject constructor(private val postItem: PostItem){
    suspend fun postItem(name :String, description : String, location: String,sublocation:String, amount : String, category : Int, status: Int, image:String) : PostItemResponse{
        val postItemRequest = PostItemData(name, description, location,sublocation, amount, category, status, image)
